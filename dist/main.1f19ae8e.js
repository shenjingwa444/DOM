...
console.log(div1);
var test = dom.find('#test')[0];
dom.after(test, div1);
dom.before(test, div1);
var a = dom.create('<a>aaa</>');
dom.append(div1, a);
var nodes = dom.empty(window.empty);
console.log(nodes);
var test1 = dom.find('#test')[0];
...
},{}]},{},["C:/Users/jason-cheng/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","main.js"], null)
